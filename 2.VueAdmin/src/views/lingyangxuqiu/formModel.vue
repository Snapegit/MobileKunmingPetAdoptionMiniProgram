		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="领养目的" prop="lingyangmude">
							<el-input class="list_inp" v-model="form.lingyangmude" placeholder="领养目的"
								 type="text" 								:readonly="!isAdd||disabledForm.lingyangmude?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="领养期望" prop="lingyangqiwang">
							<el-input v-model="form.lingyangqiwang" placeholder="领养期望" type="textarea"
							:readonly="!isAdd||disabledForm.lingyangqiwang?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='lingyangmude'){
					form.value.lingyangmude = row[x];
					disabledForm.value.lingyangmude = true;
					continue;
				}
				if(x=='lingyangqiwang'){
					form.value.lingyangqiwang = row[x];
					disabledForm.value.lingyangqiwang = true;
					continue;
				}
				if(x=='fabushijian'){
