				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="我的简介" prop="wodejianjie">
							<el-input class="list_inp" v-model="user.wodejianjie"  placeholder="我的简介" clearable />
						</el-form-item>
					</el-col>
