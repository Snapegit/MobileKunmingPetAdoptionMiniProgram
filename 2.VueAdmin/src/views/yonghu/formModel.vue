				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="所在城市" prop="suozaichengshi">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.suozaichengshi?true:false"
								v-model="form.suozaichengshi" 
								placeholder="请选择所在城市"
								>
								<el-option v-for="(item,index) in suozaichengshiLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="12">
						<el-form-item label="我的宠物" prop="wodechongwu">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.wodechongwu?true:false"
								v-model="form.wodechongwu" 
								placeholder="请选择我的宠物"
								>
								<el-option v-for="(item,index) in wodechongwuLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="12">
						<el-form-item label="个人标签" prop="gerenbiaoqian">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.gerenbiaoqian?true:false"
								v-model="form.gerenbiaoqian" 
								placeholder="请选择个人标签"
								>
								<el-option v-for="(item,index) in gerenbiaoqianLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="24">
						<el-form-item label="我的简介" prop="wodejianjie">
							<el-input v-model="form.wodejianjie" placeholder="我的简介" type="textarea"
							:readonly="!isAdd||disabledForm.wodejianjie?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup>
	...
	//所在城市列表
	const suozaichengshiLists = ref([])
	//我的宠物列表
	const wodechongwuLists = ref([])
	//个人标签列表
	const gerenbiaoqianLists = ref([])
	//methods
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='wodechongwu'){
					form.value.wodechongwu = row[x];
					disabledForm.value.wodechongwu = true;
					continue;
				}
				if(x=='gerenbiaoqian'){
					form.value.gerenbiaoqian = row[x];
					disabledForm.value.gerenbiaoqian = true;
					continue;
				}
				if(x=='wodejianjie'){
					form.value.wodejianjie = row[x];
					disabledForm.value.wodejianjie = true;
					continue;
				}
			}
			if(row){
		...
		suozaichengshiLists.value = "昆明市".split(',')
		wodechongwuLists.value = "暂无,猫狗双全,狗狗,猫咪,其他异宠".split(',')
		gerenbiaoqianLists.value = "暂无,爱心人士,资深救助人,救助站管理员".split(',')
	}
	//初始化
	//声明父级调用
	defineExpose({
