	...
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				...
				<br>
				<div class="btn_view">
					<el-button type="success" @click="addClick" v-if="btnAuth('chongwusongyang','新增')">新增</el-button>
					<el-button  v-if=" btnAuth('chongwusongyang','查看')" type="info"  :disabled="selRows.length==1?false:true" @click="infoClick(null)">详情</el-button>
					<el-button type="primary" :disabled="selRows.length==1?false:true" @click="editClick" v-if=" btnAuth('chongwusongyang','修改')">修改</el-button>
					<el-button type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('chongwusongyang','删除')">删除</el-button>
				</div>
			</div>
			<br>
			<el-table
				...
				ref="table"
				v-if="btnAuth('chongwusongyang','查看')"
				:data="list"
				...
				<el-table-column
					...
					label="是否已注射疫苗">
					<template #default="scope">
						{{scope.row.shifouyizhusheyimiao}}
					</template>
				</el-table-column>
				<el-table-column
					 :resizable='true' 
				...
				<el-table-column label="审核" v-if="btnAuth('chongwusongyang','审核')" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button type="info" v-if=" btnAuth('chongwusongyang','查看')" @click="infoClick(scope.row.id)">详情</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
...
<script setup>
	...
	const approvalClick = (row) => {
		let params = {
			...
			shifouyizhusheyimiao: row.shifouyizhusheyimiao,
			shifouyijueyu: row.shifouyijueyu,
			shifouyiquchong: row.shifouyiquchong,
			shifoumianfei: row.shifoumianfei,
